...
import mher.point.flow.ten.model.Btn;

import static mher.point.flow.ten.key.ConsKey.BEST_KEY;
import static mher.point.flow.ten.key.ConsKey.BTN_LIST_KEY;
import static mher.point.flow.ten.key.ConsKey.NEW_GAME_KEY;
import static mher.point.flow.ten.key.ConsKey.SCORE_KEY;
import static mher.point.flow.ten.key.ConsKey.SOUND_KEY;
import static mher.point.flow.ten.key.ConsKey.SP_NAME;
